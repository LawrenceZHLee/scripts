...
program_version_link="https://raw.githubusercontent.com/LawrenceZHLee/scripts/master/1click2install/version.sh"
str_install_shell=https://raw.githubusercontent.com/LawrenceZHLee/scripts/master/1click2install/install-frps.sh
shell_update(){
    fun_clangcn "clear"
